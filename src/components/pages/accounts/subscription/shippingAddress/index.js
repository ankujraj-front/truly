    ...
    return (
        <div className="container mx-auto">
           <div className="flex flex-col md:flex-row">
               ...
               <div className="w-full pt-[30px] mb-[100px] md:mb-[60px] md:pt-[0px] px-[10px] md:w-3/4 md:px-[0px]">
                    <div>
                        <div className="container mx-auto">
                            <h3 className="text-[22px] font-bold">Hello,TEST TEST</h3>
                            <p className="text-[#000] text-[15px] py-[20px]">Shipping addresses</p>
                            <Link to ='/addshippingaddress'> <button type="submit" name="add" class="primary px-[11px] py-[9px] text-[#000] uppercase rounded-[30px] border-2 min-w-[170px] border-[#ff779f] bg-[#fff]">Add Shipping address</button></Link>
                                            ...
                                            <div>
                                                ...
                                                <div class="border border-[#ff69b1] p-[16px]">
                                                    ...
                                                    <div class="text-body-2" data-id="59111071">
                                                        <p className="name text-[16px] text-[#000] font-medium">Shipping address</p>
                                                        <div className="name text-[26px] text-[#000]">
                                                          {x.name}
                                                        </div>
                                                        <div className="address-line name text-[16px] text-[#000]">
                                                            {x.adress}
                                                        </div>
                                                        <div className="city-state-zip name text-[16px] text-[#000]">
                                                        {x.city}
                                                        </div>
                                                    </div>
                                                    <div class="rct_order__details ">
                                                    <p className="name text-[16px] text-[#000] font-medium">Associated payment method</p>
                                                    ...
                                                    <div className="items_dlite">
                                                    <button type="submit" name="add" class="primary mb-[12px] px-[11px] py-[9px] text-[#000] uppercase rounded-[30px] border-2 min-w-[170px] border-[#ff779f] bg-[#fff] mr-[6px]">Change Payment Method</button>
                                                  <Link to='/editbillingaddress'>  <button type="submit" name="add" class="primary px-[11px] py-[9px] text-[#000] uppercase rounded-[30px] border-2 min-w-[170px] border-[#ff779f] bg-[#fff]">Edit Shipping  address</button></Link>
