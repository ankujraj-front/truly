                        ...
                        <div>
                            <div className="container mx-auto">
                                <div className="text-center max-w-[1000px] mx-auto">
                                    <p className="text-left text-[16px] text-[#000]"><Link to='/paymentmethods'>Payment Method</Link> &gt; Edit billing address</p>
...
export default EditBillingMethods