    ...
    return (
        <div>
            <div class="modal fade fixed top-0 left-0 hidden w-full h-full outline-none overflow-x-hidden overflow-y-auto "
                id="exampleModal35" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered relative w-auto pointer-events-none max-w-[550px]">
                    <div
                        ...
                        <div
                            ...
                            <h5 class="font-medium leading-normal text-gray-800 text-[18px] text-center px-[22px]" id="exampleModalLabel">Review us and get 25 points
                        ...
                        <p className="text-[16px] text-[#000] font-normal">Review your overall experience with us and get 25 reward points. *Review request will be emailed 3 weeks after your order delivers</p>
